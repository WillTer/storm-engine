...
public:
    ...
    virtual int32_t SetBox(const CVECTOR& boxSize, CMatrix const& transform, bool testOnly = false) = 0;
...
public:
    ...
    virtual float
    Trace(entity_container_cref entities, const CVECTOR& src, const CVECTOR& dst, entid_t const* exclude_list, int32_t exclude_num) = 0;
