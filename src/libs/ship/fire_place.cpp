...
void FirePlace::Run(
    char const* pParticleSmokeName, char const* pParticleFireName, int32_t _iBallCharacterIndex, char const* pSoundName, float _fRunTime)
{
    if (isActive()) return;
