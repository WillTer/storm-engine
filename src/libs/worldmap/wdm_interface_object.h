...
protected:
    ...
    static void DrawRects(Vertex* vrt, int32_t numRects, char const* techName = nullptr);
    ...
    static void Print(int32_t font, int32_t color, float xleft, float xright, float y, char const* format, ...);
