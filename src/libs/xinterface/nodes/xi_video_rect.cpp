...
CXI_VIDEORECT::CXI_VIDEORECT() : m_dwColor(0), m_eiVideo(0)
{
    m_rs        = nullptr;
...
void CXI_VIDEORECT::LoadIni(INIFILE* ini1, char const* name1, INIFILE* ini2, char const* name2)
{
    char param[255];
    ...
    if (ReadIniString(ini1, name1, ini2, name2, "videoFile", param, sizeof(param), "")) StartVideoPlay(param);
}
