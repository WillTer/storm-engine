...
public:
    ...
    void AddImage(char const* pcPicName, uint32_t dwColor, XYRECT pos);
...
protected:
    ...
    void SetBuffers(XI_ONETEX_VERTEX* pVBuf, uint16_t* pIBuf, int rectNum, XYRECT& scrRect, FXYRECT& texRect, uint32_t dwColor);
    void UpdateBuffers();
