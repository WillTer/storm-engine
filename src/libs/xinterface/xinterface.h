...
class XINTERFACE : public XINTERFACE_BASE
{
  ...
  public:
    ...
    int32_t PrintIntoWindow(int32_t wl, int32_t wr, int32_t idFont, uint32_t dwFCol, uint32_t dwBCol, int32_t align,
                            bool shadow, float scale, int32_t sxs, int32_t sys, int32_t left, int32_t top,
                            const char *str, int nWidthForScaleCorrecting = -1, int nSplit = 0) override;
