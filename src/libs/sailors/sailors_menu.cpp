...
void Menu::Draw(/*VDX9RENDER*/ void* rs, SailorsPoints& sailorsPoints) const
{
    ...
    for (auto i = 0; i < sailrs->shipWalk[0].sailorsPoints.points.count; i++)
        if (sailrs->shipWalk[0].sailorsPoints.points.point[i].pointType == PT_TYPE_CANNON_L
            ...
            if (sailrs->shipWalk[0].sailorsPoints.points.point[i].cannonReloaded) reloaded++;
...
{
    if (key == VK_RIGHT) sailrs->shipWalk[0].CreateNewMan(sailrs->shipWalk[0].sailorsPoints);
...
void Menu::ChangeControl2(int key, SailorsPoints& sailorsPoints)  // Change points
{
    if (shiftKey && sailorsPoints.points.selected >= 0 && sailorsPoints.points.selected < sailorsPoints.points.count) {
        switch (key) {
        case VK_UP: sailorsPoints.points.point[sailorsPoints.points.selected].y += 0.025f * dltTime / 10.0f; return;

        case VK_DOWN: sailorsPoints.points.point[sailorsPoints.points.selected].y -= 0.025f * dltTime / 10.0f; return;
    ...
    if (sailorsPoints.points.selected >= 0 && sailorsPoints.points.selected < sailorsPoints.points.count) {
        ...
        case VK_LEFT:
            sailorsPoints.points.point[sailorsPoints.points.selected].x += 0.025f * sin(cameraAng.y + PI / 2) * dltTime / 10.0f;
            sailorsPoints.points.point[sailorsPoints.points.selected].z += 0.025f * cos(cameraAng.y + PI / 2) * dltTime / 10.0f;
            break;
    ...
    if (key == VK_SPACE) {
        ...
        if (sailorsPoints.points.selected < 0) sailorsPoints.points.selected = 0;
        Update(sailorsPoints);
    }
    ...
    if (key == VK_F9) {
        if (sailorsPoints.points.selected >= 0 && sailorsPoints.points.selected < sailorsPoints.points.count) {
            switch (sailorsPoints.points.point[sailorsPoints.points.selected].pointType) {
            case PT_TYPE_NORMAL: sailorsPoints.points.point[sailorsPoints.points.selected].pointType = PT_TYPE_CANNON_L; break;
            case PT_TYPE_CANNON_L: sailorsPoints.points.point[sailorsPoints.points.selected].pointType = PT_TYPE_CANNON_R; break;
            case PT_TYPE_CANNON_R: sailorsPoints.points.point[sailorsPoints.points.selected].pointType = PT_TYPE_CANNON_F; break;
            case PT_TYPE_CANNON_F: sailorsPoints.points.point[sailorsPoints.points.selected].pointType = PT_TYPE_CANNON_B; break;
            case PT_TYPE_CANNON_B: sailorsPoints.points.point[sailorsPoints.points.selected].pointType = PT_TYPE_MAST_1; break;

            case PT_TYPE_MAST_1: sailorsPoints.points.point[sailorsPoints.points.selected].pointType = PT_TYPE_MAST_2; break;

            case PT_TYPE_MAST_2: sailorsPoints.points.point[sailorsPoints.points.selected].pointType = PT_TYPE_MAST_3; break;

            case PT_TYPE_MAST_3: sailorsPoints.points.point[sailorsPoints.points.selected].pointType = PT_TYPE_MAST_4; break;

            case PT_TYPE_MAST_4: sailorsPoints.points.point[sailorsPoints.points.selected].pointType = PT_TYPE_MAST_5; break;

            case PT_TYPE_MAST_5: sailorsPoints.points.point[sailorsPoints.points.selected].pointType = PT_TYPE_NOT_TARGETPOINT; break;

            case PT_TYPE_NOT_TARGETPOINT: sailorsPoints.points.point[sailorsPoints.points.selected].pointType = PT_TYPE_NORMAL; break;
            }
        }
        Update(sailorsPoints);
    }
    ...
    if (key == VK_DELETE) {
        for (auto i = 0; i < sailorsPoints.links.count; i++) {
            if (sailorsPoints.links.link[i].first > sailorsPoints.points.selected) sailorsPoints.links.link[i].first--;

            if (sailorsPoints.links.link[i].next > sailorsPoints.points.selected) sailorsPoints.links.link[i].next--;
        }
...
void Menu::ChangeControl3(int key, SailorsPoints& sailorsPoints)  // Change links
{
    if (key == VK_INSERT) {
        ...
        if (sailorsPoints.links.selected >= 0 && sailorsPoints.links.selected < sailorsPoints.links.count) {
            sailorsPoints.links.link[sailorsPoints.links.count - 1] = sailorsPoints.links.link[sailorsPoints.links.selected];
        } else {
  ...
  */
    ...
    if (key == VK_SPACE) {
        ...
        if (sailorsPoints.links.selected < 0) sailorsPoints.links.selected = 0;
    }

    if (key == VK_F2) {
        auto const selLnk = sailorsPoints.links.selected;
        ...
        if (selLnk < sailorsPoints.links.count && selLnk >= 0) {
            ...
            if (sailorsPoints.links.link[selLnk].first >= sailorsPoints.points.count) sailorsPoints.links.link[selLnk].first = 0;

            if (sailorsPoints.links.link[selLnk].first < 0) sailorsPoints.links.link[selLnk].first = sailorsPoints.points.count - 1;
        }
    }
    ...
    if (key == VK_F3) {
        ...
        if (selLnk < sailorsPoints.links.count && selLnk >= 0) {
            ...
            if (sailorsPoints.links.link[selLnk].next >= sailorsPoints.points.count) sailorsPoints.links.link[selLnk].next = 0;

            if (sailorsPoints.links.link[selLnk].next < 0) sailorsPoints.links.link[selLnk].next = sailorsPoints.points.count - 1;
        }
    }
...
{
    if (key == VK_F10) { sailrs->shipWalk[0].ReloadCannons(0); }
    ...
    if (key == VK_F5) { sailorsPoints.WriteToFile(_fileName_save); }
    ...
    switch (selected) {
    case 0: ChangeControl1(key, sailorsPoints); break;
    case 1: ChangeControl2(key, sailorsPoints); break;
    case 2: ChangeControl3(key, sailorsPoints); break;
    }
};
...
void Menu::OnKeyPress(SailorsPoints& sailorsPoints)
{
    ...
    if (keyPressed && !(blocked == 1 && (key == VK_UP || key == VK_DOWN || key == VK_LEFT || key == VK_RIGHT))) return;

    switch (key) {
    case VK_UP:
        if (selected && blocked == -1) selected--;
        ChangeControl(key, sailorsPoints);
        break;

    case VK_DOWN:
        if (selected < count - 1 && blocked == -1) selected++;
        ChangeControl(key, sailorsPoints);
        break;
    ...
    case VK_F4:
    case VK_F10:
    case VK_F11: ChangeControl(key, sailorsPoints); break;
    }
