...
public:
    ...
    // Get node material
    char const* GetMaterial(int32_t curNode);
...
private:
    ...
    // Find the direction of the path
    bool FindPathDir(int32_t step, int32_t curNode, const CVECTOR& cur, int32_t toNode, const CVECTOR& to, int32_t& node, CVECTOR& pos);
