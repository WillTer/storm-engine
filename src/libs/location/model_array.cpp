...
// Create model
int32_t ModelArray::CreateModel(const char *modelName, const char *technique, int32_t level, bool isVisible,
                                void *pLights)
{
...
void ModelArray::Clip(PLANE *p, int32_t numPlanes, CVECTOR &cnt, float rad,
