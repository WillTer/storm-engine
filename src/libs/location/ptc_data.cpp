...
bool PtcData::FindPathDir(int32_t curNode, const CVECTOR &cur, int32_t toNode, const CVECTOR &to, int32_t &node,
                          CVECTOR &toPos)
{
    numSteps = 0;
...
// Find the direction of the path
bool PtcData::FindPathDir(int32_t step, int32_t curNode, const CVECTOR &cur, int32_t toNode, const CVECTOR &to,
                          int32_t &node, CVECTOR &pos)
{
    if (step > numSteps)
        numSteps = step;
    Assert(curNode >= 0);
