...
class LocatorArray
{
    ...
    // --------------------------------------------------------------------------------------------
public:
    LocatorArray(char const* groupName);
...
public:
    // Add locator
    void AddLocator(CMatrix& mtx, char const* name = nullptr);
    ...
    int32_t FindByName(char const* locName);
    // Get locator name
    char const* LocatorName(int32_t locIndex);
    ...
    // Compare group names
    bool CompareGroup(char const* groupName, int32_t ghash) const;
    // Get group name
    ...
    // --------------------------------------------------------------------------------------------
public:
    static int32_t CalcHashString(char const* str);
...
// Get locator name
inline char const* LocatorArray::LocatorName(int32_t locIndex)
{
