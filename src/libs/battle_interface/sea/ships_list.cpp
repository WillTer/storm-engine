...
void SHIP_DESCRIBE_LIST::Add(int32_t mainChrIndex, int32_t chIdx, ATTRIBUTES *pChAttr, ATTRIBUTES *pShipAttr,
                             bool bMyShip, bool bTransferableShip, int32_t relation, uint32_t dwShipColor)
{
    assert(pChAttr != NULL);
