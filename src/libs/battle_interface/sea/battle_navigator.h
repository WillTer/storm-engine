...
protected:
    ...
    int32_t
    SetRectangleVertexTex(BI_ONETEXTURE_VERTEX* v, float x = .5f, float y = .5f, float width = 1.f, float height = 1.f, float angle = 0);
    int32_t SetRectangleSegVertexPos(BI_ONETEXTURE_VERTEX* v, float x, float y, float width, float height, float begAngle, float endAngle);
    int32_t SetRectangleSegVertexTex(BI_ONETEXTURE_VERTEX* v, float x, float y, float width, float height, float begAngle, float endAngle);
    ...
    void FillOneSideFireRange(BI_NOTEXTURE_VERTEX* pv, ATTRIBUTES* pShip, ATTRIBUTES* pChar, char const* pstr) const;
