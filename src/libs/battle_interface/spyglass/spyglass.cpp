...
void ISPYGLASS::ImageParam::LoadFromAttr(BIImageRender *pImgRender, ATTRIBUTES *pA, const char *pcDefName,
                                         int32_t nDefLeftPos, int32_t nDefTopPos, int32_t nDefRightPos,
                                         int32_t nDefBottomPos, int32_t nPrior)
{
...
void ISPYGLASS::ChangeTargetData(const char *pcShipName, const char *pcShipType, float fRelativeHP, float fRelativeSP,
                                 int32_t nShipCrew, float fShipSpeed, float fSailTo, int32_t nCurCannons,
                                 int32_t nMaxCannons, int32_t nCharge, int32_t nNation, int32_t nSailState,
                                 int32_t nFace, int32_t nFencing, int32_t nCannon, int32_t nAccuracy,
                                 int32_t nNavigation, int32_t nBoarding, const char *pcCaptainName,
