...
class ISPYGLASS : public Entity
{
  ...
  protected:
    ...
    void ChangeTargetData(const char *pcShipName, const char *pcShipType, float fRelativeHP, float fRelativeSP,
                          ...
                          int32_t nCharge, int32_t nNation, int32_t nSailState, int32_t nFace, int32_t nFencing,
                          int32_t nCannon, int32_t nAccuracy, int32_t nNavigation, int32_t nBoarding,
                          const char *pcCaptainName, const char *pcFaceTexture, int32_t nShipClass);
