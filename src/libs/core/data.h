...
public:
    ...
    void Set(char const* value) override;
    void Set(std::string_view const& attribute_name, std::string_view const& attribute_value) override;
    bool Get(int32_t& value) override;
    bool Get(float& value) override;
    bool Get(char const*& value) override;
    bool Get(char const* attribute_name, char const*& value) override;

    bool Set(int32_t value, uint32_t index) override;
    bool Set(float value, uint32_t index) override;
    bool Set(char const* value, uint32_t index) override;

    bool Get(int32_t& value, uint32_t index) override;
    bool Get(float& value, uint32_t index) override;
    bool Get(char const*& value, uint32_t index) override;

    bool Set(std::string_view const& attribute_name, std::string_view const& attribute_value, uint32_t index) override;
    bool Get(char const* attribute_name, char const*& value, uint32_t index) override;
