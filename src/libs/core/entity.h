...
using entity_container_cref = std::vector<entid_t> const&;

enum class layer_type_t : uint8_t { common, execute, realize };
...
public:
    ...
    enum class Stage : uint_fast8_t { execute, realize, lost_render, restore_render };
