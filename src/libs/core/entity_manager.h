...
public:
    ...
    entid_t CreateEntity(char const* name, ATTRIBUTES* attr = nullptr);
...
private:
    ...
    enum EntityState : uint8_t { kNotExists = 0, kExists = 1, kValid = 2 };
