...
public:
    ...
    virtual void  Set(std::string_view const& attribute_name, std::string_view const& attribute_value)                 = 0;
    virtual bool  Get(int32_t& value)                                                                                  = 0;
    virtual bool  Get(float& value)                                                                                    = 0;
    virtual bool  Get(char const*& value)                                                                              = 0;
    virtual bool  Get(char const* attribute_name, char const*& value)                                                  = 0;
    virtual bool  Set(int32_t value, uint32_t index)                                                                   = 0;
    virtual bool  Set(float value, uint32_t index)                                                                     = 0;
    virtual bool  Set(char const* value, uint32_t index)                                                               = 0;
    virtual bool  Get(int32_t& value, uint32_t index)                                                                  = 0;
    virtual bool  Get(float& value, uint32_t index)                                                                    = 0;
    virtual bool  Get(char const*& value, uint32_t index)                                                              = 0;
    virtual bool  Set(std::string_view const& attribute_name, std::string_view const& attribute_value, uint32_t index) = 0;
    virtual bool  Get(char const* attribute_name, char const*& value, uint32_t index)                                  = 0;
