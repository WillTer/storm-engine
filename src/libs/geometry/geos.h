...
public:
    ...
    virtual int32_t FindName(char const* name) const = 0;
    ...
    // label
    //-----------------------------------------
    enum LABEL_FLAGS { LABLE_FORCEDWORD = 0x7FFFFFFF };
    ...
    // materials
    //-----------------------------------------
    enum TEXTURE_TYPE { TEXTURE_NONE = 0, TEXTURE_BASE, TEXTURE_NORMAL, TEXTURE_LIGHTMAP, TEXTURE_FORCEDWORD = 0x7FFFFFFF };
    ...
    // light sources
    //-----------------------------------------
    enum LIGHT_TYPE { LIGHT_POINT = 0, LIGHT_SPOT, LIGHT_DIRECTIONAL, LIGHT_FORCE_DWORD = 0x7FFFFFFF };

    enum LIGHT_FLAGS { LIGHT_SHADOW = 1, LIGHT_FORCEDWORD = 0x7FFFFFFF };
    ...
    virtual bool Clip(const PLANE* planes, int32_t nplanes, const VERTEX& center, float radius, ADD_POLYGON_FUNC addpoly) = 0;
    ...
    virtual char const* GetTextureName(int32_t tx) const                  = 0;
...
enum GEOS_LOADING_FLAGS { LOAD_VISIBLE = 1, LOAD_COLLIDE = 2, LOAD_GEOACCESS = 4, LOAD_FORCEDWORD = 0x7FFFFFFF };
