...
public:
    ...
    int32_t CreateControl(char const* control_name) override;
    ...
    int32_t AddControlTreeNode(int32_t nParent, char const* pcBaseControl, char const* pcOutControl, float fTimeOut) override;
    ...
    bool    GetControlState(char const* control_name, CONTROL_STATE& _state_struct) override;
    bool    SetControlState(char const* control_name, CONTROL_STATE& _state_struct) override;
    ...
    void    LockControl(char const* control_name, bool mode) override;
