...
int32_t PCS_CONTROLS::AddControlTreeNode(int32_t nParent, const char *pcBaseControl, const char *pcOutControl,
                                         float fTimeOut)
{
...
bool PCS_CONTROLS::IsKeyPressed(int vk)
{
    ...
    {
        pressed =
            input_->KeyboardSDLKeyState(SDL_SCANCODE_RETURN) || input_->KeyboardSDLKeyState(SDL_SCANCODE_KP_ENTER);
    }
    else if (vk == VK_UP)
    {
